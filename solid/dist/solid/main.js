...
/* harmony import */ var _pages_products_list_page_products_list_page_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./pages/products-list-page/products-list-page.component */ "./src/app/pages/products-list-page/products-list-page.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _pages_products_list_page_products_list_page_component__WEBPACK_IMPORTED_MODULE_22__["ProductsListPageComponent"],
            ],
            imports: [
...
module.exports = "<div class=\"block block--green\">\r\n\t<div class=\"block__overlay block__overlay--img\" style=\"background-image: url('https://sevenstars.nl/assets/img/wemakeitspark/image07.jpg')\"></div>\r\n\r\n\t<div class=\"block__body\">\r\n\t\t<div class=\"container\">\r\n\t\t\t<div class=\"grid\">\r\n\t\t\t\t<div class=\"col--1-1\">\r\n\t\t\t\t\t<h1 class=\"block__title\">Ineedatractor.com</h1>\r\n\t\t\t\t\t<h2 class=\"block__subtitle\"> A modern online service and a mobile application to rent construction equipment and specialized vehicles.\r\n          </h2>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"col--2-5 push--1-5\">\r\n\t\t\t\t\t<p class=\"block__text\">\r\n            <ul>\r\n              Have an idea to run your business in a smarter and more efficient way without a need to buy and deploy the software itself?\r\n              Take an advantage of using already installed and configured SaaS solutions, and thus reduce your time to benefit.\r\n              How can a SaaS benefit your business?\r\n              <li>It costs less comparing to its legacy system;</li>\r\n              <li>It cuts  overhead costs;</li>\r\n              <li>It enables collaboration in large and decentralized teams;</li>\r\n              <li>It saves the time needed for setup and training;</li>\r\n              <li>It facilitates access to data;</li>\r\n              <li>It eliminates the burden of a proprietary software upgrading and maintenance.</li>\r\n            </ul>\r\n          </p>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n</div>s\r\n"
