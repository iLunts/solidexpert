...
export class ProductsListPageComponent implements OnInit {
  ...
  productList = [
    {
      title: 'PRODUCTS',
      subtitle: `Are you tired of switching between your email client, excel file,
      calendar and phone in the course of one interaction? This is where CRM comes into play.`,
      text: `To date, customer relations management (CRM) continues to be one of the most powerful
       tools for business automation. A well-tailored customized CRM system centralizes your communication
       in one place and gives you an advantage to manage all pipeline in a more efficient way.`,
